...
contractions_dict = {
    "I'm": "I am",          # Maps "I'm" to "I am"
    "you're": "you are",    # Maps "you're" to "you are"
    "he's": "he is",        # Maps "he's" to "he is"
    "she's": "she is",      # Maps "she's" to "she is"
    "it's": "it is",        # Maps "it's" to "it is"
    "we're": "we are",      # Maps "we're" to "we are"
    "they're": "they are",  # Maps "they're" to "they are"
    "aren't": "are not",    # Maps "aren't" to "are not"
    "can't": "cannot",      # Maps "can't" to "cannot"
    "couldn't": "could not",# Maps "couldn't" to "could not"
    "didn't": "did not",    # Maps "didn't" to "did not"
    "doesn't": "does not",  # Maps "doesn't" to "does not"
    "don't": "do not",      # Maps "don't" to "do not"
    "hadn't": "had not",    # Maps "hadn't" to "had not"
    "hasn't": "has not",    # Maps "hasn't" to "has not"
    "haven't": "have not",  # Maps "haven't" to "have not"
    "he'd": "he would",     # Maps "he'd" to "he would"
    "he'll": "he will",     # Maps "he'll" to "he will"
    "I'd": "I would",       # Maps "I'd" to "I would"
    "I'll": "I will",       # Maps "I'll" to "I will"
    "I've": "I have",       # Maps "I've" to "I have"
    "isn't": "is not",      # Maps "isn't" to "is not"
    "let's": "let us",      # Maps "let's" to "let us"
    "mightn't": "might not",# Maps "mightn't" to "might not"
    "mustn't": "must not",  # Maps "mustn't" to "must not"
    "shan't": "shall not",  # Maps "shan't" to "shall not"
    "she'd": "she would",   # Maps "she'd" to "she would"
    "she'll": "she will",   # Maps "she'll" to "she will"
    "shouldn't": "should not",# Maps "shouldn't" to "should not"
    "that's": "that is",    # Maps "that's" to "that is"
    "there's": "there is",  # Maps "there's" to "there is"
    "they'd": "they would", # Maps "they'd" to "they would"
    "they'll": "they will", # Maps "they'll" to "they will"
    "they've": "they have", # Maps "they've" to "they have"
    "we'd": "we would",     # Maps "we'd" to "we would"
    "we've": "we have",     # Maps "we've" to "we have"
    "weren't": "were not",  # Maps "weren't" to "were not"
    "what'll": "what will", # Maps "what'll" to "what will"
    "what're": "what are",  # Maps "what're" to "what are"
    "what's": "what is",    # Maps "what's" to "what is"
    "what've": "what have", # Maps "what've" to "what have"
    "where's": "where is",  # Maps "where's" to "where is"
    "who's": "who is",      # Maps "who's" to "who is"
    "who'll": "who will",   # Maps "who'll" to "who will"
    "who're": "who are",    # Maps "who're" to "who are"
    "who've": "who have",   # Maps "who've" to "who have"
    "won't": "will not",    # Maps "won't" to "will not"
    "wouldn't": "would not",# Maps "wouldn't" to "would not"
    "you'd": "you would",   # Maps "you'd" to "you would"
    "you'll": "you will",   # Maps "you'll" to "you will"
    "you've": "you have",   # Maps "you've" to "you have"
}
